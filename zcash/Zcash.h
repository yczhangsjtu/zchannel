...
#define ZC_TLOCK_SIZE 64
#define ZC_PKCM_SIZE 256

#define ZC_NOTEPLAINTEXT_SIZE (ZC_NOTEPLAINTEXT_LEADING + ZC_V_SIZE + ZC_RHO_SIZE + ZC_R_SIZE + ZC_MEMO_SIZE + ZC_TLOCK_SIZE + ZC_PKCM_SIZE)
